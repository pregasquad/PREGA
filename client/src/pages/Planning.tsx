                        ...
                        {(() => {
                          ...
                          const paidButton = booking.paid ? (
                            <span
                              ...
                              title={(booking as any).paypalOrderId ? `PayPal: ${(booking as any).paypalOrderId}` : t("common.paid")}
                            >
                              {(booking as any).paypalOrderId ? (
                                <span className="flex items-center gap-0.5 bg-blue-500/90 text-white text-[9px] font-bold px-1.5 py-0.5 rounded-full shadow-sm leading-none">
