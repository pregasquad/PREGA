...
export function SpinningLogo({ size = "md", className }: SpinningLogoProps) {
  return (
    <div className={cn("flex items-center justify-center", className)}>
      <div className={cn(sizeClasses[size], "rounded-full bg-white flex items-center justify-center overflow-hidden animate-spin shadow-sm")} style={{ animationDuration: "1.5s" }}>
        <img
          src="/prega_logo.png"
          alt="Loading..."
