...
import { initializeDatabase, warmupDatabase, ensurePushSubscriptionsTable, ensureAppointmentsAuditColumns, ensureForeignKeyConstraints, ensureAdminRolesPhotoColumn, ensureProductExpiryColumns, ensureServiceStartingPriceColumn, ensureServiceMaxPriceColumn, ensureServiceEmojiColumn, ensureDeductionClearedColumns, ensureDeductionPaidBackColumn, ensureStaffIdBackfillMySQL, ensureStaffPaymentsTable, ensureStaffPublicTokens, ensureAutoLockColumn, ensureChargeAttachmentColumns, ensurePlanningShortcutsColumn, ensurePlanningSlotHeightColumn, ensureAppointmentDiscountColumns, ensureTombolaSpinsTable, ensureSalonPaymentsTable, ensureBookingStatusColumn, ensureBaileysSessionTable, ensureBotMemoryTable, ensureBotMemoryPhoneColumn, ensureBotBlockedColumn, ensureTtsVoiceColumn, ensureTtsEnabledColumn, ensureMapsLinkColumn, ensureBotEnabledColumn, ensureBotFilterColumns, ensureOwnerWithdrawalsTable, ensureOwnerWithdrawalsNotesColumn, ensureCategoriesColorColumn, ensureSalonComplaintsTable, ensureComplaintTypeColumn, ensureBotSilenceAfterBookingColumn, ensurePrivateRoomColumn, ensureStaffGenderColumn, ensureStaffGenderDefaults, ensureBossInstructionsColumn, ensureLinaPersonalityColumn, ensureStaffPhotoUrlColumn, ensureLoyaltyColumnsInSettings, ensureBusinessSettingsRow, ensurePaypalOrderIdColumn, ensureHolidaysColumn, ensureBroadcastLogsTable, ensureDailySummaryColumns } from "./db";
