...
${ctx.isNewConversation
  ? "• هاد الرسالة هي الأولى في هاد المحادثة — يمكنك ترحبي بطريقة قصيرة وطبيعية"
  : "• المحادثة جارية بالفعل — لا تبدأي بـ 'أهلاً' أو 'مرحباً' أو 'أهلاً بك مرة أخرى' — ابدأي مباشرة بالجواب على سؤالها"
}
• ممنوع تستعملي "حبيبتي" في كل رسالة — استعمليها مرة مرة فقط، كثير الأحيان لا تستعمليها أبداً${clientFirstName ? `\n• إذا عرفتِ اسمها فاستعمليه بشكل طبيعي: ${clientFirstName}` : ""}
