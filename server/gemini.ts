...
6. الأيام اللي مكتوب "فارغ" → كل الأوقات متاحة في أوقات العمل (${ctx.openingTime || "09:00"}–${ctx.closingTime || "20:00"})
7. 🚫 قاعدة الوقت الحالي — مهمة جداً: إذا العميلة طلبت موعد "اليوم" → لا تقترحي أبداً ساعة تكون قبل أو تساوي الوقت الحالي (${ctx.currentTime || "الوقت الحالي"}) — اقترحي فقط الساعات اللي جاية بعد الوقت الحالي في أوقات العمل. مثال: إذا الوقت الآن 15:30 → لا تقترحي 14:00 أو 15:00 — اقترحي 16:00 أو بعدها
8. إذا ما بقاش وقت كافي اليوم (وصلنا لقرب وقت الإغلاق ${ctx.closingTime || "20:00"}) → قولي بصراحة "ما بقاش وقت اليوم، واش تقدري تجي غدا؟"` : `━━━ التقويم ━━━
