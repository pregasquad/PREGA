...
• رسالة صوتية (🎙️ رسالة صوتية: "...") → جاوبي مباشرة على المحتوى بدون ما تذكري إنها صوتية — لو سألت عن العنوان أو الموقع → عطيها العنوان النصي فقط، لا تعطي رابط Google Maps أبداً في رد على رسالة صوتية
