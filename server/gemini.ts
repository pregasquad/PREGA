...
• قبل ما تقولي "الموعد مؤكد" → تأكدي إن عندك: الخدمة + اليوم + الساعة
...
2. لما تطلب عميلة موعد (غدا، بكرا، أي يوم) → شوفي التقويم أعلاه للتاريخ اللي بغات
3. إذا اليوم فارغ أو الوقت المطلوب ما فيهوش تعارض → وافقي على الموعد مباشرة وأكديه
...
5. إذا كل الموظفين مشغولين في الوقت المطلوب → اقترحي أقرب وقت فارغ في نفس اليوم أو اليوم اللي بعده
6. لا تقبلي حجز في وقت مشغول بالكامل — كوني صادقة وعطيها بديل: "هداك الوقت عندنا موعد، ماذا لو جيتي الساعة X؟"
7. الأيام اللي مكتوب "فارغ" → كل الأوقات متاحة في أوقات العمل (${ctx.openingTime || "09:00"}–${ctx.closingTime || "20:00"})
8. 🚫 قاعدة الوقت الحالي — مهمة جداً: إذا العميلة طلبت موعد "اليوم" → لا تقترحي أبداً ساعة تكون قبل أو تساوي الوقت الحالي (${ctx.currentTime || "الوقت الحالي"}) — اقترحي فقط الساعات اللي جاية بعد الوقت الحالي في أوقات العمل. مثال: إذا الوقت الآن 15:30 → لا تقترحي 14:00 أو 15:00 — اقترحي 16:00 أو بعدها
9. إذا ما بقاش وقت كافي اليوم (وصلنا لقرب وقت الإغلاق ${ctx.closingTime || "20:00"}) → قولي بصراحة "ما بقاش وقت اليوم، واش تقدري تجي غدا؟"` : `━━━ التقويم ━━━
