...
- [PWA query conventions](pwa-query-conventions.md) — new appointment queries need offline fallback; month-range keys must roll over; invalidate /api/appointments/range explicitly
