        ...
        <div className="max-w-6xl mx-auto px-4 py-16 md:py-24 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative flex items-center justify-center">
            <div className="relative w-72 h-80 md:w-80 md:h-96">
              <div className="absolute inset-0 rounded-[2.5rem] flex flex-col items-center justify-center gap-3"
                style={{ background: "linear-gradient(145deg,#f472b6 0%,#ec4899 40%,#db2777 100%)", boxShadow: "0 30px 80px rgba(219,39,119,0.35)" }}>
                ...
                <span className="text-white/90 tracking-[0.3em] text-xs font-bold uppercase">
                  {services[0]?.category?.toUpperCase() || "BEAUTÉ"}
                </span>
